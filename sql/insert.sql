...
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E6030102018','aaa', 'Aaa Aaa', 'MXPFCO001', '2018-10-30', 'HAND','ECONOMY', 'E60', '1');    
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5930102018','alessandrabianchi', 'Alessandra Bianchi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E59', '0');  
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5830102018','brunorossi','Bruno Rossi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E58', '0');  
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE,BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5730102018','claudiaverdi', 'Claudia Verdi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E57', '1'); 
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5630102018','damianorossi', 'Damiano Rossi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E56', '1'); 
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5530102018','enricoverdi', 'Enrico Verdi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E55', '0'); 
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5430102018','francescabianchi', 'Francesca Bianchi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E54', '1'); 
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5330102018','giorgiorossi', 'Giorgio Rossi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E53', '1'); 
INSERT INTO TICKETS (ID, FLIGHTUSER, HOLDER, FLIGHT, DDATE, BAGGAGE, SEAT, NSEAT, CHECKED)
		VALUES ('MXPFCO001E5230102018','lucarossi', 'Luca Rossi', 'MXPFCO001','2018-10-30','HAND','ECONOMY','E52', '1');         
INSERT INTO BOOKEDFLIGHTS(ID, DDATE, ESEAT, BSEAT)
		VALUES('MXPFCO001', '2018-10-30', 51, 40)